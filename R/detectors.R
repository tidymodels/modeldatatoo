...
#' non-native English writers_. The study authors carried out a series of
...
#' CellPress Patterns. \url{https://doi.org/10.1016/j.patter.2023.100779}.
#'
#' **detectors.** _Simon P. Couch_. R package, release v0.0.1.
#' \url{https://github.com/simonpcouch/detectors}.
#'
#' @examples
#' \donttest{
#' data_detectors()
